...
const articleJsonLd = {
  ...
  mainEntityOfPage: "https://www.printsolution.it/blog/come-scegliere-stampante-etichette-colori",
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Come Scegliere una Stampante per Etichette a Colori", item: "https://www.printsolution.it/blog/come-scegliere-stampante-etichette-colori" },
  ],
};
      ...
      <article className="section-padding bg-white">
        <div className="container-custom max-w-3xl">
          ...
          <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col sm:flex-row gap-4 justify-between items-center">
            ...
            <a href="mailto:info@printsolution.it?subject=Richiesta%20Info%20Stampante%20Etichette&body=Buongiorno%2C%0A%0AVorrei%20informazioni%20sulle%20stampanti%20per%20etichette%20a%20colori.%0A%0AGrazie" className="btn-primary text-sm">{locale === 'it' ? 'Richiedi un Test di Stampa Gratuito' : 'Request a Free Print Test'}</a>
          </div>
        </div>
      </article>
    </>
