...
const articleJsonLd = {
  ...
  mainEntityOfPage: "https://www.printsolution.it/blog/hot-foil-stamping-cose-quando-usarlo",
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Hot Foil Stamping: Cos'è e Quando Usarlo", item: "https://www.printsolution.it/blog/hot-foil-stamping-cose-quando-usarlo" },
  ],
};
      ...
      <article className="section-padding bg-white">
        <div className="container-custom max-w-3xl">
          ...
          <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col sm:flex-row gap-4 justify-between items-center">
            ...
            <a href="mailto:info@printsolution.it?subject=Info%20Hot%20Foil%20AurumPress&body=Buongiorno%2C%0A%0AVorrei%20informazioni%20sull%27AurumPress%20per%20hot%20foil%20stamping.%0A%0AGrazie" className="btn-primary text-sm">{locale === 'it' ? 'Scopri AurumPress' : 'Discover AurumPress'}</a>
          </div>
        </div>
      </article>
    </>
