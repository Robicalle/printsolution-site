...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.printsolutionsrl.it/it/blog/stampa-digitale-vs-offset-piccoli-lotti" },
};
...
export default async function ArticleDigitaleVsOffset() {
