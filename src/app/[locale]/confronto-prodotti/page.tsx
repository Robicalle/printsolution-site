  ...
  return [
    {
      ...
      products: [
        ...
        { name: "ThunderBox", href: "/prodotti/thunderbox", image: "/images/products/thunderbox-nobg.png", tecnologia: "Inkjet single-pass CMYK", velocita: locale === 'it' ? "Fino a 28 m/min" : "Up to 28 m/min", formatoMax: locale === 'it' ? "Foglio fino a 100 cm" : "Sheet up to 100 cm", risoluzione: "Fino a 1200 × 1200 dpi", prezzo: p },
