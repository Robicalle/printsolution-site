  ...
  return [
    {
      ...
      products: [
        ...
        { name: "AB2500", href: "/prodotti/ab2500", image: "/images/products/ab2500-new-nobg.png", tecnologia: locale === 'it' ? "Box maker automatico" : "Automatic box maker", velocita: locale === 'it' ? "500-600 scatole/ora" : "500-600 boxes/hour", formatoMax: locale === 'it' ? "Cartone 1-17 mm" : "Board 1-17 mm", risoluzione: "N/A", prezzo: p },
      ],
    },
    {
