  ...
  return [
    {
      ...
      products: [
        ...
        { name: "ThunderBox", href: "/prodotti/thunderbox", image: "/images/products/thunderbox-nobg.png", tecnologia: "Inkjet single-pass CMYK", velocita: locale === 'it' ? "Fino a 28 m/min" : "Up to 28 m/min", formatoMax: locale === 'it' ? "Fino a 30 cm stampa / 100 cm supporto" : "Up to 30 cm print / 100 cm media", risoluzione: "Fino a 1200 × 1200 dpi", prezzo: p },
        ...
        { name: "AB2500", href: "/prodotti/ab2500", image: "/images/products/ab2500-new-nobg.png", tecnologia: locale === 'it' ? "Box maker automatico" : "Automatic box maker", velocita: locale === 'it' ? "500-600 scatole/ora" : "500-600 boxes/hour", formatoMax: locale === 'it' ? "Cartone 1,5-10 mm" : "Board 1.5-10 mm", risoluzione: "N/A", prezzo: p },
      ],
    },
    {
