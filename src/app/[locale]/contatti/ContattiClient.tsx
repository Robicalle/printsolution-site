  ...
  return (
    <>
      <PageHero
        ...
        subtitle={locale === 'it' ? "Richiedi informazioni, prenota una demo o visita i nostri uffici a Sesto San Giovanni." : "Request information, book a demo or visit our offices in Sesto San Giovanni."}
          ...
          <div className="grid lg:grid-cols-2 gap-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="demo">{locale === 'it' ? 'Prenota una Demo' : 'Book a Demo'}</option>
            ...
            <div className="space-y-8">
              ...
              <div className="card-modern p-6 bg-gradient-to-r from-cyan-500/5 to-magenta-500/5">
                <h3 className="text-lg font-bold text-dark-800 mb-2">{locale === 'it' ? '🎯 Prenota una Demo Gratuita' : '🎯 Book a Free Demo'}</h3>
