...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: locale === 'it'
      ...
      : "Contact Print Solution: request information, book a free demo or visit our demo room in Sesto San Giovanni (MI). Tel. +39 02 4943 9417.",
    keywords: locale === 'it'
    ...
    openGraph: {
      ...
      description: locale === 'it'
        ...
        : "Contact Print Solution: request information, book a free demo or visit our demo room in Sesto San Giovanni (MI).",
