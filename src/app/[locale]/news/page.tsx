...
function getNews(locale: string): NewsItem[] {
  if (locale === 'it') {
    return [
      { category: "Evento", title: "Print & Digital Days a Pescara: Anteprima Nazionale ThunderBox", date: "21–23 Maggio 2026", desc: "Print Solution ha partecipato ai Print & Digital Days organizzati da LCA Distribuzione a Santa Teresa di Spoltore (PE). Tre giorni di demo dal vivo con la nuova ThunderBox in anteprima nazionale: stampa single-pass CMYK su scatole e shopper con costi ridotti del 40%.", gradient: "from-cyan-500 to-cyan-600", href: "/blog/print-digital-days-pescara-thunderbox-lca-distribuzione" },
  ...
  return [
    { category: "Event", title: "Print & Digital Days in Pescara: ThunderBox National Premiere", date: "21–23 May 2026", desc: "Print Solution attended the Print & Digital Days organised by LCA Distribuzione in Santa Teresa di Spoltore (PE). Three days of live demos featuring the new ThunderBox in its Italian national premiere: single-pass CMYK printing on boxes and shoppers with 40% lower print costs.", gradient: "from-cyan-500 to-cyan-600", href: "/blog/print-digital-days-pescara-thunderbox-lca-distribuzione" },
