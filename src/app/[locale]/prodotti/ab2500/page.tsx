...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: { absolute: isIt ? "Anypack AB2500 — Box Maker per Scatole" : "Anypack AB2500 — Automatic Box Maker" },
    description: isIt
...
function getSpecs(l: string) { return l === 'it' ? [
  ...
  ["Spessore cartone", "Da 1,5 a 10 mm"],
  ...
  ["Cardboard thickness", "From 1.5 to 10 mm"],
  ["Gluing", "Hot and cold"],
...
const features = [
  ...
  },
  {
    ...
    title: "Cartone da 1,5 a 10 mm", titleEn: "Cardboard 1.5 to 10 mm",
    desc: "Lavora con un ampio range di spessori, dal cartone leggero fino a 10 mm per imballi pesanti.", descEn: "Works with a wide range of thicknesses, from lightweight cardboard up to 10 mm for heavy-duty packaging.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-10 lg:py-16 bg-white">
        <div className="container-custom max-w-4xl">
          ...
          <p className="text-gray-500 leading-relaxed mb-4">
            ...
            produttiva. La macchina lavora con cartone da 1,5 a 10 mm di spessore, adattandosi sia a imballi leggeri
          ...
          <p className="text-gray-500 leading-relaxed mb-4">
            ...
            The machine handles cardboard from 1.5 to 10 mm thick, suiting both lightweight packaging
