...
const features = [
  ...
  {
    title: "{locale === 'it' ? 'Fustellatura Semi-Rotativa' : 'Semi-Rotary Die-Cutting'}", titleEn: "Semi-Rotary Die-Cutting",
  ...
  },
  {
    ...
    desc: "Produzione ad alta velocità per gestire tirature medio-grandi con efficienza. Ideale per etichettifici che richiedono volumi costanti e tempi rapidi.", descEn: "High-speed production for efficient handling of medium-to-large runs. Ideal for label producers requiring consistent volumes and quick turnaround.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="relative rounded-3xl bg-cta-gradient p-12 sm:p-16 text-white text-center overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-3xl sm:text-4xl font-bold mb-6 tracking-tight">
                {locale === 'it' ? 'Vuoi Vedere DC250/DC350 in Azione?' : 'Want to See DC250/DC350 in Action?'}
              </h2>
