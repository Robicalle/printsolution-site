...
export default async function DLFPage() {
          ...
          <div className="relative rounded-3xl bg-cta-gradient p-12 sm:p-16 text-white text-center overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-white/80 max-w-2xl mx-auto mb-10 text-lg leading-relaxed">
                {locale === 'it' ? 'Contattaci per una demo o per ricevere campioni di etichette fustellate con i tuoi file.' : 'Contact us for a demo or to receive sample labels die-cut with your files.'}
              </p>
              <a
