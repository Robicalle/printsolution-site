...
export default async function AnyPressPage() {
  ...
  const faqJsonLd = {
    ...
    mainEntity: isIt ? [
      ...
      { "@type": "Question", name: "Può stampare packaging flessibile come bustine e sacchetti?", acceptedAnswer: { "@type": "Answer", text: "Sì. La Any-Press è progettata per stampare sia etichette adesive in bobina che packaging flessibile come pouches, sachets e film flessibili, purché compatibili con la tecnologia LED laser." } },
      ...
      { "@type": "Question", name: "Can it print flexible packaging such as pouches and bags?", acceptedAnswer: { "@type": "Answer", text: "Yes. The Any-Press is designed for both adhesive roll labels and flexible packaging such as pouches, sachets and flexible film, provided they are compatible with LED laser technology." } },
