...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: isIt ? "AurumPress — Stampante Hot Foil per Etichette" : "AurumPress — Hot Foil Stamping Machine",
    description: isIt
        ...
        <div className="container-custom">
          ...
          <div className="swipe-gallery md:grid-cols-2 gap-8 max-w-5xl mx-auto scrollbar-hide">
            <div className="aspect-video rounded-2xl overflow-hidden shadow-lg">
              <video controls playsInline preload="none" poster="/images/posters/aurumpress-1.jpg" className="w-full h-full rounded-2xl">
                <source src="/videos/aurumpress-1.mp4" type="video/mp4" />
              </video>
            </div>
            <div className="aspect-video rounded-2xl overflow-hidden shadow-lg">
              <video controls playsInline preload="none" poster="/images/posters/aurumpress-2.jpg" className="w-full h-full rounded-2xl">
