...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: { absolute: isIt ? "EDM-650X — Stampante Single-Pass per Cartone" : "EDM-650X — Single-Pass Corrugated Printer" },
    description: isIt
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify([
        { "@context":"https://schema.org","@type":"VideoObject","name":"EDM-650X — Stampante Inkjet Single-Pass per Cartone Ondulato","description":"Demo EDM-650X: stampante inkjet industriale single-pass per packaging su cartone ondulato. Fino a 30 m/min, 1200 dpi, testine HP.","thumbnailUrl":"https://www.printsolutionsrl.it/images/posters/edm650x-1.jpg","uploadDate":"2024-01-01","contentUrl":"https://www.printsolutionsrl.it/videos/edm650x-1.mp4","publisher":{"@type":"Organization","name":"Print Solution S.r.l.","url":"https://www.printsolutionsrl.it"} },
        { "@context":"https://schema.org","@type":"VideoObject","name":"EDM-650X — Stampa Digitale su Packaging Industriale","description":"EDM-650X in funzione: stampa digitale su scatole in cartone ondulato e imballaggi industriali personalizzati.","thumbnailUrl":"https://www.printsolutionsrl.it/images/posters/edm650x-2.jpg","uploadDate":"2024-01-01","contentUrl":"https://www.printsolutionsrl.it/videos/edm650x-2.mp4","publisher":{"@type":"Organization","name":"Print Solution S.r.l.","url":"https://www.printsolutionsrl.it"} },
        { "@context":"https://schema.org","@type":"VideoObject","name":"EDM-650X — Linea di Produzione Packaging Digitale Completa","description":"Linea produzione EDM-650X per stampa packaging digitale su cartone ondulato: alta velocità, qualità industriale.","thumbnailUrl":"https://www.printsolutionsrl.it/images/posters/edm650x-4.jpg","uploadDate":"2024-01-01","contentUrl":"https://www.printsolutionsrl.it/videos/edm650x-4.mp4","publisher":{"@type":"Organization","name":"Print Solution S.r.l.","url":"https://www.printsolutionsrl.it"} }
      ]) }} />
      {/* Hero */}
        ...
        <div className="container-custom">
          ...
          <div className="swipe-gallery md:grid-cols-2 gap-8 max-w-5xl mx-auto scrollbar-hide">
            <div className="aspect-video rounded-2xl overflow-hidden shadow-lg">
              <video controls playsInline preload="none" poster="/images/posters/edm650x-1.jpg" className="w-full h-full rounded-2xl">
                <source src="/videos/edm650x-1.mp4" type="video/mp4" />
              </video>
            </div>
            <div className="aspect-video rounded-2xl overflow-hidden shadow-lg">
              <video controls playsInline preload="none" poster="/images/posters/edm650x-2.jpg" className="w-full h-full rounded-2xl">
                <source src="/videos/edm650x-2.mp4" type="video/mp4" />
              </video>
            </div>
            <div className="aspect-video rounded-2xl overflow-hidden shadow-lg">
              <video controls playsInline preload="none" poster="/images/posters/edm650x-4.jpg" className="w-full h-full rounded-2xl">
