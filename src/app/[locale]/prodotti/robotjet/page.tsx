...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: { absolute: isIt ? "RobotJet — Stampante per Labbratura Libri" : "RobotJet — Book Edge Printer" },
    description: isIt
        ...
        <div className="container-custom">
          ...
          <div className="swipe-gallery md:grid-cols-2 gap-8 max-w-5xl mx-auto scrollbar-hide">
            <div className="aspect-video rounded-2xl overflow-hidden shadow-lg">
              <video controls playsInline preload="none" poster="/images/posters/robotjet-1.jpg" className="w-full h-full rounded-2xl">
                <source src="/videos/robotjet-1.mp4" type="video/mp4" />
              </video>
            </div>
            <div className="aspect-video rounded-2xl overflow-hidden shadow-lg">
              <video controls playsInline preload="none" poster="/images/posters/robotjet-2.jpg" className="w-full h-full rounded-2xl">
