...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: isIt
        ? "ThunderBox | Stampante Digitale Single-Pass per Scatole — Novità 2026"
        : "ThunderBox | Digital Single-Pass Printer for Boxes — New 2026",
      description: isIt
      ...
      images: ["/images/products/thunderbox.jpg"],
      type: "website",
    ...
    alternates: {
      canonical: locale === 'it'
        ? `https://www.printsolutionsrl.it/prodotti/thunderbox`
        : `https://www.printsolutionsrl.it/en/prodotti/thunderbox`,
      languages: {
        'it': `https://www.printsolutionsrl.it/prodotti/thunderbox`,
        'en': `https://www.printsolutionsrl.it/en/prodotti/thunderbox`,
        'x-default': `https://www.printsolutionsrl.it/prodotti/thunderbox`,
      },
    },
  };
}

const thunderboxJsonLd = {
  ...
  image: "https://www.printsolutionsrl.it/images/products/thunderbox.jpg",
  manufacturer: { "@type": "Organization", name: "Print Solution S.r.l." },
  offers: {
    "@type": "Offer",
    url: "https://www.printsolutionsrl.it/prodotti/thunderbox",
...
function getFeatures(l: string) {
  ...
  return [
    ...
    },
    {
      ...
      desc: it
        ? "La ThunderBox riduce i costi di stampa fino al 40% rispetto a GreenBox 2, rendendo la personalizzazione del packaging conveniente dal primo pezzo."
        : "ThunderBox reduces print costs by up to 40% compared to GreenBox 2, making packaging personalisation cost-effective from the very first piece.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default async function ThunderBoxPage() {
  const locale = await getLocale();
  const it = locale === 'it';
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "ThunderBox", item: it ? "https://www.printsolutionsrl.it/prodotti/thunderbox" : "https://www.printsolutionsrl.it/en/prodotti/thunderbox" },
    ],
  };
  ...
  const faqJsonLd = {
    ...
    mainEntity: it ? [
      {
        "@type": "Question",
        name: "Cos'è la ThunderBox?",
        acceptedAnswer: { "@type": "Answer", text: "La ThunderBox è la nuova stampante digitale inkjet single-pass CMYK per scatole in cartone ondulato e shopper in carta. Novità 2026, raggiunge 28 m/min con risoluzione 1200×1200 dpi e supporta fogli fino a 100 cm di larghezza e 15 cm di spessore." },
      },
      {
        "@type": "Question",
        name: "Quanto costa la ThunderBox?",
        acceptedAnswer: { "@type": "Answer", text: "Per informazioni sul prezzo della ThunderBox contatta il nostro team: info@printsolutionsrl.it oppure chiama il +39 02 49 43 9417. Grazie agli incentivi Industria 4.0 del 2026, il costo reale può ridursi sensibilmente tramite la deduzione fiscale." },
      },
      {
        "@type": "Question",
        name: "Che differenza c'è tra ThunderBox e GreenBox EVO?",
        acceptedAnswer: { "@type": "Answer", text: "La ThunderBox è il modello entry level: la scelta ideale per le PMI che iniziano a stampare il packaging in-house, con ottima qualità, costi accessibili e rientro dell'investimento rapido. La GreenBox EVO è il modello avanzato, pensato per chi ha volumi più elevati e cerca la massima produttività e versatilità. Entrambe stampano su scatole in cartone ondulato e shopper in carta." },
      },
      {
        "@type": "Question",
        name: "La ThunderBox è compatibile con gli incentivi fiscali 2026?",
        acceptedAnswer: { "@type": "Answer", text: "Sì. La ThunderBox è certificata Industria 4.0 Ready ed è compatibile con gli incentivi fiscali 2026. Con una maggiorazione del 180% sull'ammortamento e aliquota IRES al 24%, il risparmio fiscale può arrivare al 43,2% del valore del bene." },
      },
      {
        "@type": "Question",
        name: "Per quali settori è adatta la ThunderBox?",
        acceptedAnswer: { "@type": "Answer", text: "La ThunderBox è ideale per la stampa di packaging in cartone ondulato per vino, calzature, beverage, cosmetica, e-commerce e retail. Stampa anche shopper in carta personalizzati con qualità professionale." },
      },
    ] : [
      {
        "@type": "Question",
        name: "What is the ThunderBox?",
        acceptedAnswer: { "@type": "Answer", text: "The ThunderBox is the new single-pass CMYK inkjet digital printer for corrugated boxes and paper shoppers. New in 2026, it reaches 28 m/min at 1200×1200 dpi resolution and handles sheets up to 100 cm wide and 15 cm thick." },
      },
      {
        "@type": "Question",
        name: "How much does the ThunderBox cost?",
        acceptedAnswer: { "@type": "Answer", text: "For ThunderBox pricing, contact our team: info@printsolutionsrl.it or call +39 02 49 43 9417. Thanks to 2026 Industry 4.0 incentives, the real cost can be significantly reduced through the tax deduction." },
      },
      {
        "@type": "Question",
        name: "What sectors is the ThunderBox suitable for?",
        acceptedAnswer: { "@type": "Answer", text: "The ThunderBox is ideal for printing corrugated packaging for wine, footwear, beverages, cosmetics, e-commerce and retail. It also prints custom paper shoppers to professional quality standards." },
      },
    ],
  };
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(thunderboxJsonLd) }} />
      ...
      <section className="relative text-white pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="container-custom px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">ThunderBox</h1>
      ...
      <section className="px-4 sm:px-6 lg:px-8 pt-6 pb-10 lg:pt-8 lg:pb-16 bg-white">
        <div className="container-custom max-w-4xl">
          ...
          <p className="text-gray-500 leading-relaxed">
            {it
              ? 'Certificata Industria 4.0 Ready e compatibile con gli incentivi fiscali 2026, la ThunderBox è pensata per chi vuole avviare la stampa in-house con un investimento accessibile. Con la maggiorazione fiscale al 180% prevista per i beni strumentali 4.0, il rientro dell\'investimento è rapido già dai primi mesi di utilizzo.'
              : 'Industry 4.0 Ready certified and eligible for 2026 fiscal incentives, ThunderBox is designed for businesses starting in-house printing with an accessible investment. With the 180% fiscal enhancement for 4.0 capital goods, the return on investment is fast from the first months of use.'}
          </p>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-10 lg:py-16 bg-surface-50">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-bold text-dark-800 mb-6">{it ? 'Stampa Scatole e Packaging con la ThunderBox' : 'Print Boxes & Packaging with ThunderBox'}</h2>
          <p className="text-gray-500 max-w-xl mx-auto mb-8">
            {it
              ? 'Porta i tuoi materiali — scatole in cartone o shopper — e testa la ThunderBox nella nostra sala demo a Sesto San Giovanni.'
              : 'Bring your materials — cardboard boxes or shoppers — and test ThunderBox in our demo room in Sesto San Giovanni.'}
          </p>
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { name: "Anypack AB2500", desc: it ? "Box maker automatico — abbinabile alla ThunderBox" : "Automatic box maker — combinable with ThunderBox", href: "/prodotti/ab2500", image: "/images/products/ab2500-hero-nobg.png" },
            ].map((p) => (
