      ...
      <div className="container-custom px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Tutte le nostre stampanti e macchine a confronto. Trova la soluzione perfetta per le tue esigenze.
          </p>
        </div>
          ...
          <table className="w-full min-w-[900px] text-sm">
            <thead>
              <tr className="bg-gradient-to-r from-gray-900 to-gray-800 text-white">
                <th className="text-left px-5 py-4 font-semibold sticky left-0 bg-gray-900 z-10 min-w-[200px]">
                  Prodotto
                </th>
                {columns.map((col) => (
                  <th key={col.key} className="text-left px-5 py-4 font-semibold">
                    {col.label}
                  </th>
                ))}
              </tr>
                ...
                >
                  <td className="px-5 py-4 sticky left-0 z-10 bg-inherit">
                    <Link href={product.href} className="flex items-center gap-3 group">
                      <div className="w-12 h-12 flex-shrink-0 relative bg-gray-50 rounded-lg overflow-hidden">
                        <Image
                          src={product.image}
                          alt={product.name}
                          fill
