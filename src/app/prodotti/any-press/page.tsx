...
const features = [
  ...
  },
  {
    ...
    desc: "Il toner laser LED garantisce resistenza all'acqua, ai raggi UV, ai graffi e alle condizioni esterne senza necessità di rivestimenti aggiuntivi.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="mailto:info@printsolutionsrl.it?subject=Richiesta%20Demo%20Any-Press&body=Buongiorno%2C%0A%0AVorrei%20richiedere%20una%20demo%20di%20Any-Press.%0A%0AGrazie" className="btn-secondary text-lg !px-8 !py-4">Prenota una Demo</a>
              </div>
            </div>
            <div className="relative h-72 lg:h-96 rounded-3xl overflow-hidden">
              <Image src="/images/products/any-press.avif" alt="Any-Press" fill className="object-contain p-4" priority />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="aspect-video rounded-2xl overflow-hidden shadow-lg">
              <video controls preload="metadata" className="w-full h-full object-cover"><source src="/videos/any-press.mp4" type="video/mp4" /></video>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-surface-50">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="mailto:info@printsolutionsrl.it?subject=Richiesta%20Demo%20Any-Press&body=Buongiorno%2C%0A%0AVorrei%20richiedere%20una%20demo%20di%20Any-Press.%0A%0AGrazie" className="btn-outline text-lg">Prenota una Demo</a>
          </div>
        </div>
      </section>
