...
export default function PromoUsatoPage() {
  return (
    <>
      <PageHero
        title="Promozioni & Usato Garantito"
        subtitle="Occasioni imperdibili su macchine da stampa e packaging. Tutte le macchine usate sono revisionate, testate e coperte da garanzia 6 mesi."
        breadcrumb="Promo & Usato"
      />

      {/* Intro */}
      <section className="py-12 bg-gradient-to-r from-orange-50 to-cyan-50">
        ...
        <div className="container-custom px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-3xl bg-gradient-to-r from-orange-500 via-orange-400 to-yellow-400 p-12 sm:p-16 text-white text-center overflow-hidden">
            ...
            <div className="relative">
              ...
              <Link
                href="/contatti"
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-orange-600 font-bold rounded-full hover:bg-yellow-50 transition-all duration-300 shadow-lg text-lg"
              >
