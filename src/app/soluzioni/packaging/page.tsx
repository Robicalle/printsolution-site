...
const products = [
  ...
  {
    name: "AurumPress",
    subtitle: "Pressa per Stampa a Caldo (Hot Foil)",
    desc: "Macchina per doratura e stampa con foil metallizzati su shopper, sacchetti, cartoncino e packaging. Effetto luxury con oro, argento, rame e colori metallizzati. Ideale per boutique, gioiellerie e brand premium.",
    specs: [
      "Area stampa 33 × 40 cm",
      "Spessore max 15 cm",
      "Collo a cigno versatile",
      "Controllo temperatura digitale",
      "Avanzamento foil motorizzato",
      "Foil oro, argento, rame, olografico",
      "Formazione in mezza giornata",
      "Sistema oleodinamico robusto",
    ],
  ...
  },
  {
    ...
    subtitle: "Stampante per Labbratura Libri",
    desc: "Stampante digitale rivoluzionaria per la labbratura e personalizzazione del bordo delle pagine di libri, quaderni, agende e block notes. Tecnologia inkjet a base acqua CMYK con teste HP A3, stampa fondi pieni e sfumature con precisione fino a 1200 dpi.",
    specs: [
      "400 pezzi/ora, 3200/giorno",
      "Risoluzione fino a 1200 dpi",
      "CMYK single-pass, 4 colori",
      "Altezza libro 90–350 mm",
      "Adattamento intelligente forma",
      "Taniche inchiostro 1L per colore",
      "Pulizia automatica testina",
      "Teste di stampa HP A3",
    ],
