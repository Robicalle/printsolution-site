  ...
  const navigation = [
    { label: t("home"), href: "/", homeOnly: true },
    {
      ...
      children: [
        ...
        { label: t("products"), href: "/prodotti", desc: t("productsDesc") || "Tutta la gamma completa" },
      ],
    },
    ...
    >
      <div className="container-custom flex items-center justify-between h-20 px-4 sm:px-6 lg:px-8">
        ...
        <nav aria-label="Navigazione principale" className="hidden lg:flex items-center gap-1">
          ...
          <a href={`mailto:info@printsolutionsrl.it?subject=${emailSubject}&body=${emailBody}`} className="btn-primary ml-3 text-sm !py-2 !px-5 animate-pulse-subtle whitespace-nowrap" data-track="click_cta" data-track-label="header_consulenza">{t("requestDemo")}</a>
