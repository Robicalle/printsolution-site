...
export const categories: Category[] = [
  ...
  {
    slug: "pigmentati-greenbox-evo",
    name: "GreenBox EVO — Pigmentati",
    description: "Inchiostri pigmentati a base acqua per stampante GreenBox EVO (1 litro)",
    image: "/images/shop/placeholder.png",
    products: [
      { id: "gbevo-pig-y", name: "Inchiostro Pigmentato YELLOW per GreenBox EVO (1L)", sku: "GBEVO-PIG-Y", price: 0, image: "/images/shop/placeholder.png", inStock: true },
      { id: "gbevo-pig-c", name: "Inchiostro Pigmentato CYAN per GreenBox EVO (1L)", sku: "GBEVO-PIG-C", price: 0, image: "/images/shop/placeholder.png", inStock: true },
      { id: "gbevo-pig-m", name: "Inchiostro Pigmentato MAGENTA per GreenBox EVO (1L)", sku: "GBEVO-PIG-M", price: 0, image: "/images/shop/placeholder.png", inStock: true },
      { id: "gbevo-pig-k", name: "Inchiostro Pigmentato BLACK per GreenBox EVO (1L)", sku: "GBEVO-PIG-K", price: 0, image: "/images/shop/placeholder.png", inStock: true },
    ],
  },
  {
    slug: "dye-greenbox-evo",
    name: "GreenBox EVO — Dye",
    description: "Inchiostri dye per stampante GreenBox EVO (1 litro)",
    image: "/images/shop/placeholder.png",
    products: [
      { id: "gbevo-dye-y", name: "Inchiostro Dye YELLOW per GreenBox EVO (1L)", sku: "GBEVO-DYE-Y", price: 0, image: "/images/shop/placeholder.png", inStock: true },
      { id: "gbevo-dye-c", name: "Inchiostro Dye CYAN per GreenBox EVO (1L)", sku: "GBEVO-DYE-C", price: 0, image: "/images/shop/placeholder.png", inStock: true },
      { id: "gbevo-dye-m", name: "Inchiostro Dye MAGENTA per GreenBox EVO (1L)", sku: "GBEVO-DYE-M", price: 0, image: "/images/shop/placeholder.png", inStock: true },
      { id: "gbevo-dye-k", name: "Inchiostro Dye BLACK per GreenBox EVO (1L)", sku: "GBEVO-DYE-K", price: 0, image: "/images/shop/placeholder.png", inStock: true },
    ],
  },
  {
    slug: "pigmentati-edm650x",
    name: "EDM-650X — Pigmentati",
    description: "Inchiostri pigmentati a base acqua per stampante EDM-650X (1 litro)",
    image: "/images/shop/placeholder.png",
    products: [
      { id: "edm-pig-y", name: "Inchiostro Pigmentato YELLOW per EDM-650X (1L)", sku: "EDM-PIG-Y", price: 0, image: "/images/shop/placeholder.png", inStock: true },
      { id: "edm-pig-c", name: "Inchiostro Pigmentato CYAN per EDM-650X (1L)", sku: "EDM-PIG-C", price: 0, image: "/images/shop/placeholder.png", inStock: true },
      { id: "edm-pig-m", name: "Inchiostro Pigmentato MAGENTA per EDM-650X (1L)", sku: "EDM-PIG-M", price: 0, image: "/images/shop/placeholder.png", inStock: true },
      { id: "edm-pig-k", name: "Inchiostro Pigmentato BLACK per EDM-650X (1L)", sku: "EDM-PIG-K", price: 0, image: "/images/shop/placeholder.png", inStock: true },
    ],
  },
  {
    slug: "dye-edm650x",
    name: "EDM-650X — Dye",
    description: "Inchiostri dye per stampante EDM-650X (1 litro)",
    image: "/images/shop/placeholder.png",
    products: [
      { id: "edm-dye-y", name: "Inchiostro Dye YELLOW per EDM-650X (1L)", sku: "EDM-DYE-Y", price: 0, image: "/images/shop/placeholder.png", inStock: true },
      { id: "edm-dye-c", name: "Inchiostro Dye CYAN per EDM-650X (1L)", sku: "EDM-DYE-C", price: 0, image: "/images/shop/placeholder.png", inStock: true },
      { id: "edm-dye-m", name: "Inchiostro Dye MAGENTA per EDM-650X (1L)", sku: "EDM-DYE-M", price: 0, image: "/images/shop/placeholder.png", inStock: true },
      { id: "edm-dye-k", name: "Inchiostro Dye BLACK per EDM-650X (1L)", sku: "EDM-DYE-K", price: 0, image: "/images/shop/placeholder.png", inStock: true },
    ],
  },
  {
