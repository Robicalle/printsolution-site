...
export const categories: Category[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { id: "gbevo-pig-m", name: "Inchiostro Pigmentato MAGENTA per GreenBox EVO (1L)", sku: "GBEVO-PIG-M", price: 0, image: "/images/shop/placeholder.png", description: "Pigmentato", inStock: true },
      { id: "gbevo-pig-k", name: "Inchiostro Pigmentato BLACK per GreenBox EVO (1L)", sku: "GBEVO-PIG-K", price: 0, image: "/images/shop/placeholder.png", description: "Pigmentato", inStock: true },
      { id: "gbevo-dye-y", name: "Inchiostro Dye YELLOW per GreenBox EVO (1L)", sku: "GBEVO-DYE-Y", price: 0, image: "/images/shop/placeholder.png", description: "Dye", inStock: true },
      { id: "gbevo-dye-c", name: "Inchiostro Dye CYAN per GreenBox EVO (1L)", sku: "GBEVO-DYE-C", price: 0, image: "/images/shop/placeholder.png", description: "Dye", inStock: true },
      { id: "gbevo-dye-m", name: "Inchiostro Dye MAGENTA per GreenBox EVO (1L)", sku: "GBEVO-DYE-M", price: 0, image: "/images/shop/placeholder.png", description: "Dye", inStock: true },
      { id: "gbevo-dye-k", name: "Inchiostro Dye BLACK per GreenBox EVO (1L)", sku: "GBEVO-DYE-K", price: 0, image: "/images/shop/placeholder.png", description: "Dye", inStock: true },
    ],
  },
  {
    ...
    products: [
      ...
      { id: "edm-pig-m", name: "Inchiostro Pigmentato MAGENTA per EDM-650X (1L)", sku: "EDM-PIG-M", price: 0, image: "/images/shop/placeholder.png", description: "Pigmentato", inStock: true },
      { id: "edm-pig-k", name: "Inchiostro Pigmentato BLACK per EDM-650X (1L)", sku: "EDM-PIG-K", price: 0, image: "/images/shop/placeholder.png", description: "Pigmentato", inStock: true },
      { id: "edm-dye-y", name: "Inchiostro Dye YELLOW per EDM-650X (1L)", sku: "EDM-DYE-Y", price: 0, image: "/images/shop/placeholder.png", description: "Dye", inStock: true },
      { id: "edm-dye-c", name: "Inchiostro Dye CYAN per EDM-650X (1L)", sku: "EDM-DYE-C", price: 0, image: "/images/shop/placeholder.png", description: "Dye", inStock: true },
      { id: "edm-dye-m", name: "Inchiostro Dye MAGENTA per EDM-650X (1L)", sku: "EDM-DYE-M", price: 0, image: "/images/shop/placeholder.png", description: "Dye", inStock: true },
      { id: "edm-dye-k", name: "Inchiostro Dye BLACK per EDM-650X (1L)", sku: "EDM-DYE-K", price: 0, image: "/images/shop/placeholder.png", description: "Dye", inStock: true },
    ],
  },
  {
