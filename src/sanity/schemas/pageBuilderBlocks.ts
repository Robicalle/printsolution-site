...
export const localeString = (name: string, titleIt: string, titleEn: string) => [
  defineField({ name, title: titleIt, type: "string" }),
  defineField({ name: `${name}_en`, title: titleEn, type: "string" }),
];

export const localeText = (name: string, titleIt: string, titleEn: string) => [
...
export const productCardListBlock = {
  type: "object",
    ...
    defineField({
      ...
      of: [{
        ...
        fields: [
          ...
          defineField({ name: "specs", title: "Specifiche (IT)", type: "array", of: [{ type: "string" }] }),
          defineField({ name: "specs_en", title: "Specifiche (EN)", type: "array", of: [{ type: "string" }] }),
...
export const useCasesGridBlock = {
  type: "object",
  name: "useCasesGrid",
...
export const consumablesCategoryListBlock = {
  type: "object",
...
export const carePackGridBlock = {
  type: "object",
  name: "carePackGrid",
...
export const productPhotoBlock = {
  type: "object",
  name: "productPhoto",
  title: "Product Photo",
  fields: [
...
export const productVideoBlock = {
  type: "object",
  name: "productVideo",
  title: "Product Video",
  fields: [
...
export const solutionCategoryListBlock = {
  type: "object",
...
export const soluzioniHeroBlock = {
  type: "object",
  name: "soluzioniHero",
